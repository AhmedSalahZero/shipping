                                    ...
                                    <div class="tab-pane active" id="tab_0">
                                        <div class="portlet box green">
                                            <div class="portlet-title">
                                                <div class="caption">
                                                    <i class="fa fa-gift"></i>Add Languages </div>
                                            </div>
                                                ...
                                                <form action="{{route('languages.store')}}" method="POST" enctype="multipart/form-data" class="form-horizontal">
                                                    ...
                                                    <div class="form-body">
                                                        ...
                                                        <div class="form-group">
                                                            ...
                                                            <div class="col-md-6">
                                                                <div class="input-icon">
                                                                    <input  value='{{old("name")}}' type="text" class="form-control input-circle" placeholder="Name" name="name"> 
                                                                    @error('name')
                                                                    <div >
                                                        ...
                                                        <div class="form-group">
                                                            ...
                                                            <div class="col-md-6">
                                                                <div class="input-icon">
                                                                    <input  value='{{old("code")}}' type="text" class="form-control input-circle" placeholder="Code" name="code">
                                                                    @error('code')
                                                                    <div >
                                                                        <span class="text-danger my-2">{{ $message }}</span>
                                                                    </div>
